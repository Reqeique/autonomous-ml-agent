...
2. Set `WANDB_ENTITY` / `WANDB_PROJECT` / `WANDB_SWEEP_ID` as env in
   `.github/workflows/opencode-ml-agent.yml`. These are **not** secrets but
   are kept out of the committed README/AGENTS.md to avoid publishing
   personal usernames in the public mirror.
